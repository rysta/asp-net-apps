...
{
    /// <summary>
    /// Класс для отчета  ArrivedMilitary - Все прибывшие военнообязанные.
    /// </summary>
    public static class ArrivedMilitaryReport
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static List<TemplateForJsonResponse> GetArrivedMilitaryReport( string dateRDFrom, string dateRDBefore, string dateSTFrom, string dateSTBefore )
        {
            try
            {
                ...
                command.CommandText = Resources.ResourceQuery.arrived_military_report;
